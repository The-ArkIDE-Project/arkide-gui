...
import {ACCENT_BLUE, ACCENT_MAP, ACCENT_PURPLE, ACCENT_RED, ACCENT_RAINBOW, ACCENT_ARKIDE, Theme} from '../../lib/themes/index.js';
...
const options = defineMessages({
    ...
    [ACCENT_ARKIDE]: {
        defaultMessage: 'ArkIDE',
        description: 'Name of the ArkIDE color scheme.',
        id: 'tw.accent.arkide'
    }
});
